...
with open(f"data/tokenizer-output-{sufix}-2sE.json", "r", encoding="utf-8") as f:
    enc2 = json.load(f)
...
enc = PreTrainedTokenizerFast(tokenizer_file=f"data/tokenizer-output-{sufix}-2sE.json")
...
# microstate 4 maps 30000 vocab

#train has 1,069,496 tokens
#val has 117,799 tokens